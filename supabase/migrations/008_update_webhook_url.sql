-- =============================================
-- Baat-IA — Migration 008 : Mise à jour URL ngrok
-- =============================================
...
BEGIN
  PERFORM net.http_post(
    url := 'https://5223-41-82-59-70.ngrok-free.app/api/process-segment',
...
BEGIN
  PERFORM net.http_post(
    url := 'https://5223-41-82-59-70.ngrok-free.app/api/generate-export',
    body := jsonb_build_object(
      'type', 'INSERT',
      'table', 'exports',
      'record', jsonb_build_object(
