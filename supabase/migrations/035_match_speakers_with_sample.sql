-- =============================================
-- Baat-IA — Migration 035 : expose sample_storage_path dans match_speakers_for_project
-- =============================================
-- Le drawer d'invitation dans un projet doit pouvoir afficher le player
-- de démo à côté de chaque locuteur proposé.
-- =============================================
...
BEGIN
  ...
  SELECT
    ...
    s.sample_storage_path,
    s.sample_duration_seconds
  FROM scored s
