    ...
    <div className="p-5 sm:p-6 lg:p-8 max-w-[76rem]">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-sand-900 to-sand-950 dark:from-sand-900 dark:to-sand-950 p-6 sm:p-8 mb-6 border border-sand-800">
        ...
        <div className="relative">
          ...
          {project.description && (
            <p className="text-sand-400 text-sm mb-3 max-w-[65ch]">{project.description}</p>
          )}
      ...
      {showDeleteModal && (
        ...
        >
          <div className="bg-white dark:bg-sand-900 rounded-2xl shadow-xl border border-sand-200/60 dark:border-sand-800 p-6 w-full max-w-[28rem] animate-scale-in">
